...
{
    public CancelUnpaidOrdersHandler(IDateTimeProvider dateTimeProvider, IOrderRepository orderRepository,
    ...
    public async Task<Unit> Handle(CancelUnpaidOrdersJob request, CancellationToken cancellationToken)
    {
        ...
        var unpaidOrders = await _orderRepository.FindAll(
            o => o.Status == OrderStatus.Created && o.CreatedAt <= threshold, cancellationToken, 100,
            LockMode.ForUpdateSkipLocked, q => q.OrderBy(o => o.CreatedAt));
