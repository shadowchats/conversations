# Shadowchats.Conversations

В будущем: микросервис чатов мессенджера Shadowchats. Сейчас (временно в качестве костыля): полигон для разработки репозитория-шаблона для микросервисов мессенджера Shadowchats
...
- GitHub repository: https://github.com/shadowchats/conversations
