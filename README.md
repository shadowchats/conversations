...
Микросервис чатов мессенджера Shadowchats и по совместительству (временно в качестве костыля) - полигон для разработки репозитория-шаблона для микросервисов
